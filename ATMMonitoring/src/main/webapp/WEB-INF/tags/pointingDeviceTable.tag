...
<h3><spring:message code="label.pointingDevices"/></h3>
...
<tr>
	...
	<th><i><label><spring:message code="label.hardwareDevice.hardwareType"/></label></i></th>
	<th><i><label><spring:message code="label.hardwareDevice.pointingType"/></label></i></th>
