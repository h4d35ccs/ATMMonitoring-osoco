...
<t:osoco-wrapper titleCode="label.upsQueryEngine" userMsg="${userMsg}"  section="terminals">
				...
				<div id="header_g">
					<nav id="breadcrumb">
						<ul>
							...
							<li>
								<a href="ups"><spring:message code="breadcrumb.ups"/></a>
							</li>
							<li><a href="upsQueries/list"><spring:message code="label.queries.mine"/></a></li>
