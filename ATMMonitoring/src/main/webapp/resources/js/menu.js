...
// Colorbox
	...
	$(".iframe_medium").colorbox({iframe:true, width:"640", height:"530px", maxWidth:"100%", maxHeight:"100%"}); // Iframes
	$(".iframe_m").colorbox({iframe:true, width:"1000px", height:"600px"}); // Iframes Mapa
