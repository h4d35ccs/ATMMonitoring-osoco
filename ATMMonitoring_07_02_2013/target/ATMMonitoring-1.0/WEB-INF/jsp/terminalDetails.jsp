...
<c:choose>
	...
	<table id="TestChromatable" class="data subform">
		<thead>
		<tr>
			<th><i><spring:message code="label.financialDevice.name"/></i></th>
			<th><i><spring:message code="label.financialDevice.majorVersion"/></i></th>
			<th><i><spring:message code="label.financialDevice.serialNumber"/></i></th>
			<th><i><spring:message code="label.financialDevice.caption"/></i></th>
			<th><i><spring:message code="label.financialDevice.description"/></i></th>
			<th><i><spring:message code="label.financialDevice.universalId"/></i></th>
			<th><i><spring:message code="label.financialDevice.deviceInstance"/></i></th>
			<th><i><spring:message code="label.financialDevice.deviceStatus"/></i></th>
			<th><i><spring:message code="label.financialDevice.pmStatus"/></i></th>
			<th><i><spring:message code="label.financialDevice.model"/></i></th>
			<th><i><spring:message code="label.financialDevice.variant"/></i></th>
			<th><i><spring:message code="label.financialDevice.manufacturer"/></i></th>
			<th><i><spring:message code="label.financialDevice.firmwareMajorVersion"/></i></th>
			<th><i><spring:message code="label.financialDevice.removable"/></i></th>
			<th><i><spring:message code="label.financialDevice.replaceable"/></i></th>
			<th><i><spring:message code="label.financialDevice.hotSwappable"/></i></th>
			<th><i><spring:message code="label.financialDevice.xfsComponents"/></i></th>
		</tr>
		</thead>
	</c:when>
	<c:otherwise>
	<table class="data subform">
		...
		<th width="55px"><i><spring:message code="label.financialDevice.xfsComponents"/></i></th>
		</tr>
		</thead>
	</c:otherwise>
	</c:choose>
...
<c:if test="${!empty terminal.softwareAggregates}">
	<c:choose>
	<c:when  test="${terminal.softwareAggregates.size() > 5}">
...
<c:if test="${!empty terminal.hotfixes}">
	<c:choose>
	<c:when  test="${terminal.hotfixes.size() > 5}">
