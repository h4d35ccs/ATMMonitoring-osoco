...
import com.ncr.ATMMonitoring.serverchain.adapter.ATMSocketComunicationParams;
import com.ncr.ATMMonitoring.serverchain.adapter.ATMUpdateRequestAdapter;
import com.ncr.ATMMonitoring.serverchain.adapter.ATMUpdateRequestAdapterImpl;
...
//	    }
	...
	ATMUpdateRequestAdapter adapter = new ATMUpdateRequestAdapterImpl();
	ATMSocketComunicationParams params = this.setUpAdapterParams();
	adapter.setupAdapter(updateInfo, params);
	adapter.requestATMUpdate();
    }
    
    private ATMSocketComunicationParams setUpAdapterParams(){
	
	ATMSocketComunicationParams params = new ATMSocketComunicationParams();
