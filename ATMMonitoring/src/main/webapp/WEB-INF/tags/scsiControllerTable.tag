...
<h5><spring:message code="label.scsiControllers"/></h5>
...
<tr>
	...
	<th><i><label><spring:message code="label.hardwareDevice.hardwareVersion"/></label></i></th>
	<th><i><label><spring:message code="label.hardwareDevice.driverName"/></label></i></th>
