...
/**
 *  Class that define a parse based on SAX<br>
...
public abstract class ParseUPSSAX extends ParseUPSXML {
	 ...
	 * The concrete class <b> must implement the logic related to the {@link DefaultHandler} <b>
	 ...
	 */
	protected void parse(InputStream xmlFile) throws ParserException, XMLNotReadableException{
