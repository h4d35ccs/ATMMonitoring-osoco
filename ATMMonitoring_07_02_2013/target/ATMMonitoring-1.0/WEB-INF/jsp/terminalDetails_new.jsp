...
<c:otherwise>	
    ...
    <table class="form-disabled">
	    ...
	    <tr>
	        <td class="header last-header"><i><label><spring:message code="label.terminal.tracerNumber"/></label></i></td>
	        <td class="last-header"><label>${terminal.tracerNumber}</label></td>
	    </tr>
	</table>
	</div>
</c:otherwise>
...
<c:if test="${!empty terminal.financialDevices}">
	...
	<thead>
	<tr>
		<th scope="col"><i><spring:message code="label.financialDevice.name"/></i></th>
		<th scope="col"><i><spring:message code="label.financialDevice.majorVersion"/></i></th>
		<th scope="col"><i><spring:message code="label.financialDevice.serialNumber"/></i></th>
		<th scope="col"><i><spring:message code="label.financialDevice.caption"/></i></th>
		<th scope="col"><i><spring:message code="label.financialDevice.description"/></i></th>
		<th scope="col"><i><spring:message code="label.financialDevice.universalId"/></i></th>
		<th scope="col"><i><spring:message code="label.financialDevice.deviceInstance"/></i></th>
		<th scope="col"><i><spring:message code="label.financialDevice.deviceStatus"/></i></th>
		<th scope="col"><i><spring:message code="label.financialDevice.pmStatus"/></i></th>
		<th scope="col"><i><spring:message code="label.financialDevice.model"/></i></th>
		<th scope="col"><i><spring:message code="label.financialDevice.variant"/></i></th>
		<th scope="col"><i><spring:message code="label.financialDevice.manufacturer"/></i></th>
		<th scope="col"><i><spring:message code="label.financialDevice.firmwareMajorVersion"/></i></th>
		<th scope="col"><i><spring:message code="label.financialDevice.removable"/></i></th>
		<th scope="col"><i><spring:message code="label.financialDevice.replaceable"/></i></th>
		<th scope="col"><i><spring:message code="label.financialDevice.hotSwappable"/></i></th>
		<th scope="col"><i><spring:message code="label.financialDevice.xfsComponents"/></i></th>
	</tr>
	</thead>
	<tbody>
	    ...
	    <tr <c:if test="${alt}">class="alt"</c:if>>
		    ...
		    <td><label>${financialDevice.pmStatus}</label></td>
		    <td><label>${financialDevice.model}</label></td>
		    <td><label>${financialDevice.variant}</label></td>
		    <td><label>${financialDevice.manufacturer}</label></td>
		    <td><label>${financialDevice.firmwareVersion}</label></td>
		    <td><label>${financialDevice.removable}</label></td>
		    <td><label>${financialDevice.replaceable}</label></td>
			<td><label>${financialDevice.hotSwappable}</label></td>
		    <td>
		    	<c:forEach items="${financialDevice.xfsComponents}" var="xfsComponent">
		    	<a href="terminals/xfsComponents/details/${xfsComponent.id}">${xfsComponent.serviceProvider}</a><br>
		    	</c:forEach>
		    </td>
		</tr>
