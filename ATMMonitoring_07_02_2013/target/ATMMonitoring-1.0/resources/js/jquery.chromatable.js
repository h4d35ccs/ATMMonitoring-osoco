...
(function($){
    ...
    $.chromatable = {
		...
		return this.each(function(){
				...
				//Eva - 18/03/2013 - Copy the name of the original table
				...
				$("#"+$uniqueID).css(
					 ...
					 {'border':'2px solid #CCCCCC', //Eva - 19/03/2013 - Replicate original borders
						'overflow-x':'hidden',
						'overflow-y':'auto',
						'padding-right':'17px'						
						});
				...
				$(this).before($(this).clone().attr("id", "").addClass("_thead").css(
						...
						{'width' : 'auto',
						 ...
						 'position':'absolute', 
						 'border':'none', 
						 'border-bottom':'1px solid #CCC', //Eva - 19/03/2013 - Replicate original borders
						 'top':'2px', //Eva - 19/03/2013 - Replicate original borders
						}));
				...
				//Eva - 18/03/2013 - Apply invisibility to the header of the scrolled table
				$("#"+$genID+">thead").css('visibility','hidden');
