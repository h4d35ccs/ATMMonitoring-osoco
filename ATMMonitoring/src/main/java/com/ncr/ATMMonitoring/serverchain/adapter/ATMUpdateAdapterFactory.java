...
/**
 * Factory class in charge of returning the correct type of adapter (ATMUpdateRequestAdapter or getUpdateResponseAdapter)  
 * @author Otto Abreu
 *
 */
public class ATMUpdateAdapterFactory {
     ...
     * 
     * If the adapterType param does not matches with anything, an IllegalArgumentException is thrown
     * 
     * @param adapterType String (use the constants of the class to set this param)
     * @return
     */
    public static ATMUpdateRequestAdapter getRequestAdapterInstance(String adapterType){
	...
	default:
	    ...
	    throw new IllegalArgumentException("Wrong type of  Request adapter, use the constant of the class to avoid errors, received:"+adapterType);
	}
     ...
     */
    public static ATMUpdateResponseAdapter getUpdateResponseAdapter(String adapterType){
	...
	default:
	    ...
	    throw new IllegalArgumentException("Wrong type of Response adapter, use the constant of the class to avoid errors, received:"+adapterType);
	}
